...
public class Receiver {
	...
	public static void main(String[] args) throws Exception
	{
	    ...
	    receiverSocket.receive(handshake1);
	    ...
	    int syn1 = Integer.parseInt(receive1_set[0]);
		int seq1 = Integer.parseInt(receive1_set[1]);
		int ack1 = seq1+1;
		...
		receiverSocket.send(handshake2);
		...
		receiverSocket.receive(handshake3);
	    ...
	    int syn3 = Integer.parseInt(receive3_set[0]);
	    int seq3 = Integer.parseInt(receive3_set[1]);
	    int ack3 = Integer.parseInt(receive3_set[2]);
	    ...
	    if(syn3==0 && seq3==ack1 && ack3==seq2+1)
	    {
	    	...
	    	while(true)
	    	{
	    		...
	    		if(receive_string.startsWith("fin"))
	    		{
	    		    ...
	    		    int fin = Integer.parseInt(end_split1[0]);
	    		    int end_seq1 = Integer.parseInt(end_split1[1]);
	    		    int end_ack1 = Integer.parseInt(end_split1[2]);
	    		    ...
	    		    fin = Integer.parseInt(end_split3[0]);
	    		    int end_seq3 = Integer.parseInt(end_split3[1]);
	    		    int end_ack3 = Integer.parseInt(end_split3[2]);
	    		...
	    		int receive_seq=Integer.parseInt(receive_set[0]);
	    		int receive_ack=Integer.parseInt(receive_set[1]);
	    		...
	    		if (receive_seq==want_seq)
	    		{
	    			...
	    			for(int i=0; i<content.size(); i++)
	    			{
	    				if (content.get(i)[3].equals("no") || i==content.size()-1)
	    				{
	    	    			...
	    	    			receiverSocket.send(send_packet);
	    				}
	    			}
